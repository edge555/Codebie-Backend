...
namespace Service.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IAuthRepository authRepository, IUserRepository userRepository, IMapper mapper, IJwtTokenHandler jwtTokenHandler, IDateTimeHandler dateTimeHandler, IPasswordHandler passwordHandler, DtoValidatorBase<SignupDto> signupDtoValidator, DtoValidatorBase<LoginDto> loginDtoValidator)
        {
